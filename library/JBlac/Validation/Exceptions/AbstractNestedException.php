...
class JBlac_Validation_Exceptions_AbstractNestedException extends JBlac_Validation_Exceptions_ValidationException
{
    ...
    public function addRelated(JBlac_Validation_Exceptions_ValidationException $related)
    {
    ...
    public function getRelated($full=false)
    {
        if (!$full && 1 === count($this->related)
            && current($this->related) instanceof JBlac_Validation_Exceptions_AbstractNestedException) {
