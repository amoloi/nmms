...
class JBlac_Validation_Rules_Zend extends JBlac_Validation_Rules_AbstractRule
{
    ...
    public function __construct($validator, $params=array())
    {
        ...
        if (!is_string($validator)) {
            throw new JBlac_Validation_Exceptions_ComponentException('Invalid Validator Construct');
        }
