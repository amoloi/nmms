...
class JBlac_Validation_Rules_Each extends JBlac_Validation_Rules_AbstractRule
{
    public $itemValidator;
    public $keyValidator;

    public function __construct(JBlac_Validation_Validatable $itemValidator = null,
                                JBlac_Validation_Validatable $keyValidator=null)
    {
    ...
    public function assert($input)
    {
        ...
        foreach ($input as $key => $item) {
            if (isset($this->itemValidator)) {
                ...
                } catch (JBlac_Validation_ValidationException $e) {
                    $exceptions[] = $e;
                }
            }
