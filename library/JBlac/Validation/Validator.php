 ...
 */
class JBlac_Validation_Validator extends JBlac_Validation_Rules_AllOf
{
    ...
    {
        if ($ruleSpec instanceof JBlac_Validation_Validatable) {
            return $ruleSpec;
        }

        try {
            $validatorFqn = 'JBlac_Validation_Rules_' . ucfirst($ruleSpec);
            ...
            throw new JBlac_Validation_Exceptions_ComponentException($e->getMessage());
        }
    }
    ...
    {
        $exception = new JBlac_Validation_Exceptions_AllOfException;
        $input = JBlac_Validation_Exceptions_AllOfException::stringify($input);
